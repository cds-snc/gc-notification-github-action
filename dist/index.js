...
var restClient = (__nccwpck_require__(6545)["default"]),
    createGovukNotifyToken = __nccwpck_require__(4001),
    notifyProductionAPI = 'https://api.notifications.service.gov.uk',
    version = (__nccwpck_require__(1627)/* .version */ .i8);
...
var ApiClient = __nccwpck_require__(7215);
...
var NotifyClient = (__nccwpck_require__(634).NotifyClient);
...
const NotifyClient = (__nccwpck_require__(8563).NotifyClient);
const uuid = __nccwpck_require__(9633);
